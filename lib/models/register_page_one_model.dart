...
//
//     final registerPageOneModel = registerPageOneModelFromJson(jsonString);

import 'dart:convert';

RegisterPageOneModel registerPageOneModelFromJson(String str) => RegisterPageOneModel.fromJson(json.decode(str));
